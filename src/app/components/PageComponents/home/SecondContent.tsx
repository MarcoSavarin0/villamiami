...
const arrayContent = [
    {
        logo: <FaSpa className="text-5xl text-[#ff7400]"/>,
    ...
    {
        logo: <FaDiaspora className="text-5xl text-[#ff7400]"/>,
    ...
    {
        logo: <FaSwimmingPool className="text-5xl text-[#ff7400]"/>,
    ...
    {
        logo: <CgGym className="text-5xl text-[#ff7400]"/>,
    ...
    {
        logo: <FaRegBuilding className="text-5xl text-[#ff7400]"/>,
...
const SecondContent = () => {
    return (
        <div className="bg-[#f8f8f8] grid grid-cols-1 gap-3 lg:grid-cols-2 xl:grid-cols-3 px-56 py-10">
            {arrayContent.map((item, index) => (
                <div key={index} className="flex flex-col justify-between items-center bg-[#ffffff]">
                    <div className="flex flex-col justify-center items-center px-11">
                        ...
                        <p className=" text-[#b4b6bb] mb-6">{item.description}</p>
                    </div>
                </div>
            ))}
        </div>
